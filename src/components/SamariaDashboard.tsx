...
const [roundMembers, setRoundMembers] = useState([
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/house-visit-queue/${loggedInLeader.branch}/SAMARIA`
    );
...
const loadMembers = async () => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/members/${loggedInLeader.branch}/Samaria`
    );
  ...
  >
    ...
    <div>
      ...
      >
        ...
        <div
          onClick={() => {
            setChatUserName(loggedInLeader?.full_name || "SAMARIA Leader");
            setChatSenderType("Leader");
            setChatDepartment("SAMARIA");
            setChatBackPage("samaria-dashboard");
            setPage("group-chat");
          }}
          style={{
        ...
        <div
          onClick={() => {
            setAnnouncementDepartment("SAMARIA");
            setAnnouncementBackPage("samaria-dashboard");
...
export default SamariaDashboard;
