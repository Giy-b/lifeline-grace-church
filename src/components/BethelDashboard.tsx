...
const [roundMembers, setRoundMembers] = useState([
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/house-visit-queue/${loggedInLeader.branch}/BETHEL`
    );
...
const loadMembers = async () => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/members/${loggedInLeader.branch}/Bethel`
    );
  ...
  >
    ...
    <div>
      ...
      >
        ...
        <div
          onClick={() => {
            setChatUserName(loggedInLeader?.full_name || "BETHEL Leader");
            setChatSenderType("Leader");
            setChatDepartment("BETHEL");
            setChatBackPage("bethel-dashboard");
            setPage("group-chat");
          }}
          style={{
        ...
        <div
          onClick={() => {
            setAnnouncementDepartment("BETHEL");
            setAnnouncementBackPage("bethel-dashboard");
...
export default BethelDashboard;
