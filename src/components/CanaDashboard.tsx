...
const [roundMembers, setRoundMembers] = useState([
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/house-visit-queue/${loggedInLeader.branch}/CANA`
    );
...
const loadMembers = async () => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/members/${loggedInLeader.branch}/Cana`
    );
  ...
  >
    ...
    <div>
      ...
      >
        ...
        <div
          onClick={() => {
            setChatUserName(loggedInLeader?.full_name || "CANA Leader");
            setChatSenderType("Leader");
            setChatDepartment("CANA");
            setChatBackPage("cana-dashboard");
            setPage("group-chat");
          }}
          style={{
        ...
        <div
          onClick={() => {
            setAnnouncementDepartment("CANA");
            setAnnouncementBackPage("cana-dashboard");
